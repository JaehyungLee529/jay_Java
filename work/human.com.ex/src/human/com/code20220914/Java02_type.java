...
public class Java02_type {
	...
	public static void main(String[] args) {
		...
		// = 대입연산자
		// 1 실제 할당된 값
		// num이라는 변수이름에는 int타입(숫자,정수)으로만 데이터를 넣을 수 있다고 선언
...
//		char charA = "a";
		...
		// 변수이름은 첫글자 소문자를 추천 (대문자일경우 타입과 헷갈릴 수 있음)
		...
		// 변수가 하는일 ? 데이터를 저장하고 꺼내서 쓰는 저장소로써
		// 반복적인 업무를 할 때 사용
		String name = "김준석";
		String job = "선생님";
		String abc = "3클래스";
		...
		System.out.println(name + space + job + space + abc + space + efg + space + hif);

	}

	public static void test01Output() {
		System.out.println("---------");
	}
