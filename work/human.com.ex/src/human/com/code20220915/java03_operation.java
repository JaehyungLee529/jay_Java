...
//		//false일 경우 40이 좌측변수 check003에 할당
...
//		System.out.println(2+3*2);
		...
		// x>0 이 true false인지 먼저 확인하고
		// y<0이 true인지 false인지 확인 한 뒤에
		// &&를 통해서 true/false값 출력
		// A&& B 는 A조건과 B조건이 모두 true이면 true표시
		// A || B눈 A조건과 B조건중에 1개만 만족해도 true표시
